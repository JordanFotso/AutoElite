...
public abstract class CommandeCreator {
    ...
    public abstract Commande createCommande(Vehicule vehicule, double montantTotal);
    ...
    public Commande creerEtPreparerCommande(Vehicule vehicule, double montantInitial, String paysLivraison) {
        Commande commande = createCommande(vehicule, montantInitial);
        commande.calculerTotalAvecTaxes(paysLivraison);
